...
<div class="header">	
      <div class="container"> 
         <div class="header-top">
      		 <div class="logo">
				<a href="#"><img src="/ui/images/logo.png" alt=""/></a>
			 </div>
		 ...
		 <div class="index-banner">
				   	...
				   	<div class="banner-wrap">
				   	       <div class="bannertop_box">
				   		 		...
				   		 		<div class="cart_bg">
							  	      ...
							  	      <li><a href="#"><img src="/ui/images/close.png" alt=""/></a></li>
							  	      <li><a href="#">Edit</a></li>
							  		</ul>
							  		<div class='clearfix'></div>
							  	</div>
            ...
            <script src="/ui/js/jquery.wmuSlider.js"></script> 
			  <script>
       			$('.example1').wmuSlider();         
   		     </script> 	           	      
      </div>
			...
			<div class="row">
				<div class="col-md-3">
					<div class="menu_box">
					   ...
					   <div class="banner_img"><img src="/ui/images/pic9.jpg" class="img-responsive" alt=""/></div>
		...
		<div class="container">
		  <div class="brands">
			 <ul class="brand_icons">
				<li><img src='/ui/images/icon1.jpg' class="img-responsive" alt=""/></li>
				<li><img src='/ui/images/icon2.jpg' class="img-responsive" alt=""/></li>
				<li><img src='/ui/images/icon3.jpg' class="img-responsive" alt=""/></li>
				<li><img src='/ui/images/icon4.jpg' class="img-responsive" alt=""/></li>
				<li><img src='/ui/images/icon5.jpg' class="img-responsive" alt=""/></li>
				<li><img src='/ui/images/icon6.jpg' class="img-responsive" alt=""/></li>
				<li class="last"><img src='/ui/images/icon7.jpg' class="img-responsive" alt=""/></li>
			 </ul>
		   </div>
	    </div>
	    <div class="container">
	      <div class="instagram_top">
	        ...
	        <ul class="instagram_grid">
			  <li><a class="popup-with-zoom-anim" href="#small-dialog1"><img src="/ui/images/i1.jpg" class="img-responsive"alt=""/></a></li>
			  <li><a class="popup-with-zoom-anim" href="#small-dialog1"><img src="/ui/images/i2.jpg" class="img-responsive" alt=""/></a></li>
			  <li><a class="popup-with-zoom-anim" href="#small-dialog1"><img src="/ui/images/i3.jpg" class="img-responsive" alt=""/></a></li>
			  <li><a class="popup-with-zoom-anim" href="#small-dialog1"><img src="/ui/images/i4.jpg" class="img-responsive" alt=""/></a></li>
			  <li><a class="popup-with-zoom-anim" href="#small-dialog1"><img src="/ui/images/i5.jpg" class="img-responsive" alt=""/></a></li>
			  <li class="last_instagram"><a class="popup-with-zoom-anim" href="#small-dialog1"><img src="/ui/images/i6.jpg" class="img-responsive" alt=""/></a></li>
			  <div class="clearfix"></div>
			  <div id="small-dialog1" class="mfp-hide">
				<div class="pop_up">
					<h4>A Sample Photo Stream</h4>
					<img src="/ui/images/i_zoom.jpg" class="img-responsive" alt=""/>
				</div>
			  </div>
			</ul>
		  </div>
			...
			<div class="container">
				...
				<div class="footer-grid">
				  ...
				  <div class="footer-grid">
			        ...
			        <img src="/ui/images/payment.png" class="img-responsive" alt=""/>
				 </div>
